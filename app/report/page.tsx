      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-0 shadow-lg animate-scale-in">
          <CardContent className="text-center py-8">
            ...
            {!isPending && (
              <div className="mb-6">
                <div className="font-mono text-lg font-semibold">{successRef}</div>
                <div className="mt-2 flex gap-2 justify-center">
                  ...
                  <Button onClick={() => router.push(`/status/${encodeURIComponent(successRef)}`)} className="px-3">
                    View Status
                  </Button>
                </div>
              </div>
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-background via-background to-muted/30">
      <div className="pointer-events-none absolute inset-0 -z-10 [mask-image:radial-gradient(60%_50%_at_50%_10%,#000_40%,transparent_100%)]">
        <div className="absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"></div>
      </div>
      <header className="border-b bg-card/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">Report a Concern</h1>
      ...
      <div className="container mx-auto px-3 md:px-4 py-6 md:py-8 max-w-2xl">
        <div className="rounded-2xl p-[1.5px] bg-gradient-to-b from-primary/30 via-primary/10 to-transparent">
        <Card className="rounded-2xl border border-border/50 shadow-xl bg-card/90 supports-[backdrop-filter]:backdrop-blur-xl animate-fade-in-up">
          ...
          <CardContent className="pt-4 sm:pt-6">
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 animate-fade-in-up">
              ...
              <div className="space-y-2">
                <Label htmlFor="reporter_full_name">Full Name</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="reporter_phone">Contact Number</Label>
                <div className="relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in-up">
                <div className="space-y-2">
                  <Label htmlFor="reporter_block">Block</Label>
                  <Input
                    id="reporter_block"
                    placeholder="Block"
                ...
                <div className="space-y-2">
                  <Label htmlFor="reporter_lot">Lot</Label>
                  <Input
                    id="reporter_lot"
                ...
                <div className="space-y-2">
                  <Label htmlFor="reporter_phase">Phase</Label>
                  <Input
                    id="reporter_phase"
                    placeholder="Phase"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in-up">
                <div className="space-y-2">
                  <Label htmlFor="reporter_street">Street</Label>
                  <div className="relative">
              ...
              <div className="pt-2 animate-fade-in-up">
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Concern Details</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in-up">
                <div className="space-y-2">
                  <Label htmlFor="category">Issue Related To *</Label>
              ...
              <div className="space-y-2 animate-fade-in-up">
                <Label htmlFor="suggested_solution">Do you have any solution to suggest?</Label>
                <Textarea
              ...
              <div className="flex items-start gap-3 rounded-md border p-3 bg-muted/20 animate-fade-in-up">
                <Checkbox
                  id="acknowledged"
                  ...
                  disabled={isSubmitting}
                />
                <Label htmlFor="acknowledged" className="text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3 animate-fade-in-up">
                <Button type="button" variant="outline" onClick={() => router.push("/")} disabled={isSubmitting} className="w-full sm:flex-1">
                  Cancel
                </Button>
                <Button type="submit" disabled={isSubmitting} className="w-full sm:flex-1 shadow-md hover:shadow-lg">
