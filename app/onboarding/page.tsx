...
export default function OnboardingPage() {
    ...
    // State for rejection reason (fetched once if rejected)
    const [rejectionReason, setRejectionReason] = useState<string | null>(null)
    useEffect(() => {
        if (registrationStatus === 'rejected' && session.user) {
    ...
    }, [registrationStatus, session.user])
            ...
            <div className="w-full max-w-md space-y-8">
                ...
                >
                    ...
                    <p className="text-center text-slate-500 mb-4">
                        Your registration was not approved by the admin team.
                    </p>
                    {rejectionReason && (
                        <div className="w-full bg-red-50 border border-red-100 rounded-xl px-4 py-3 mb-4 text-left">
